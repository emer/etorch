...
type Layer struct {
	...
	// a 0..n-1 index of the position of the layer within list of layers in the network.
	...
	// map of states of the layer (activation, etc) -- name is variable name, tensor holds the data
